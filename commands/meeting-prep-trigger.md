...
5. Build the same four prioritized checklists (Follow-ups / Challenges / Growth / Achievements) as `/meeting-prep` step 5, following `Templates/Meeting Prep Template.md`'s exact shape (fall back to `references/meeting-prep-template.md`).
