...
4. Read that person's Profile Card and Skills Matrix in full, and scan `Tasks/📥 Backlog` and `Boards/Personal.md` for open items tied to them - cross-check against these, don't let them drive the note. Before compiling step 5, explicitly pull out the Profile Card's **"Where they're headed"**, **Strengths**, and **Growth watch** sections, exactly as `/meeting-prep` step 4 does - they anchor the compilation, not just background reading.
5. Build the same four prioritized checklists (Follow-ups / Challenges / Growth / Achievements) as `/meeting-prep` step 5, following `Templates/Meeting Prep Template.md`'s exact shape (fall back to `references/meeting-prep-template.md`) - including weighing Growth against "Where they're headed" and calling out Achievements that play to a named Strength, per that same step.
